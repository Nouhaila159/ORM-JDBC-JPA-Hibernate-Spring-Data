...
public class SpringH2MySqlApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        //Ajout Manuel
        patientRepository.save(new Patient(null,"Nouhaila",new Date(),false,56));
        patientRepository.save(new Patient(null,"Ohtman",new Date(),false,60));
        patientRepository.save(new Patient(null,"Fatna",new Date(),false,39));
        //Ajout par Boucle
        for (int i=0;i<100;i++){
        ...
        if(patient_modifie != null){
            ...
            System.out.println("Le Patient que vous voulez modifié n'existe pas");
        }
